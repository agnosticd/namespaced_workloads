# ocp4_workload_tenant_argocd_user
...
- agnosticd.namespaced_workloads.ocp4_workload_tenant_argocd_user
...
# Variables
ocp4_workload_tenant_argocd_user_username: "user-{{ guid }}"
ocp4_workload_tenant_argocd_user_cluster_resource_whitelist:
- group: ""
  kind: Namespace
...
| `_username` | `user-{{ guid }}` | Username for the AppProject |
...
All variables are prefixed with `ocp4_workload_tenant_argocd_user`.
