# ocp4_workload_tenant_gitea_user
...
# Variables
ocp4_workload_tenant_gitea_user_username: "user-{{ guid }}"
ocp4_workload_tenant_gitea_user_password: "{{ common_password }}"
ocp4_workload_tenant_gitea_user_repositories:
- name: mcp
...
| `_username` | `user-{{ guid }}` | Gitea username to create |
...
All variables are prefixed with `ocp4_workload_tenant_gitea_user`.
